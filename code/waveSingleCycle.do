...
add wave -noupdate -radix decimal /hart_tb/halt
...
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/_eq
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/_slt
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/_instruction
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_halted
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_is_jal_r
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_pc_mod
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_use_pc_reg
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_mem_write
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_mem_read
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_reg_write
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_mem_size
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_write_sel
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_alu_op
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_use_imm
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_i_sub
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_i_arith
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/c_i_unsigned
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/opcode
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/funct3
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/funct7
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/opcode
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/funct3
add wave -noupdate -radix hexadecimal /hart_tb/dut/control_unit_state/funct7
add wave -noupdate -divider ALU
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/i_opsel
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/i_sub
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/i_unsigned
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/i_arith
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/i_op1
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/i_op2
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/o_result
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/o_eq
add wave -noupdate -radix hexadecimal /hart_tb/dut/execute_state/alu_main/o_slt
add wave -noupdate -radix hexadecimal /hart_tb/dut/o_dmem_mask
add wave -noupdate -divider {Hart Interface}
